...
abstract class DispatcherTest extends \PHPUnit_Framework_TestCase {
    ...
    /**
     * @expectedException \FastRoute\BadRouteException
     * @expectedExceptionMessage Cannot register two controllers matching "/user/([^/]+)" for method "GET"
     */
    ...
    public function provideFoundDispatchCases() {
        ...
        // 11 ---- More specified controllers are not shadowed by less specific of another method ------>
        ...
        // 12 ---- Handler of more specific controllers is used, if it occurs first -------------------->
